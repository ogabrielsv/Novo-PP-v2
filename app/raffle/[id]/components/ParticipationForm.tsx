            ...
            <div className="bg-black border border-stone-800 rounded-3xl p-8 text-center space-y-6 animate-in fade-in zoom-in duration-300 relative overflow-hidden ring-1 ring-white/10">
                ...
                <div className="space-y-3 relative z-10 pt-2">
                    ...
                    >
                        ...
                        < div className="absolute -inset-0.5 bg-green-500 rounded-2xl blur opacity-30 group-hover:opacity-60 transition duration-1000 group-hover:duration-200 animate-pulse" ></div>

                        {/* Main Button */}
                        <div className="relative w-full bg-[#25D366] hover:bg-[#22c55e] text-white py-4 rounded-xl transition-all transform hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-green-900/20 flex flex-col items-center justify-center gap-1 overflow-hidden px-4">
