...
export function ParticipationForm({ raffleId, whatsappUrl, imageUrl }: ParticipationFormProps) {
        ...
        return (
            <div className="bg-black border border-stone-800 rounded-3xl p-8 text-center space-y-6 animate-in fade-in zoom-in duration-300 relative overflow-hidden ring-1 ring-white/10">
                ...
                <div className="relative z-10 pt-2">
                    {imageUrl ? (
                        <div className="w-24 h-24 mx-auto rounded-2xl overflow-hidden shadow-2xl border-2 border-stone-800 relative z-10 group">
                ...
                <div className="space-y-3 relative z-10 pt-2">
                    <a
                        ...
                        className="w-full bg-[#25D366] hover:bg-[#22c55e] text-white py-4 rounded-2xl transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-xl shadow-green-900/30 flex flex-col items-center justify-center gap-1 relative overflow-hidden group px-4"
                    >
                        ...
                        <div className="flex items-center gap-3 relative z-10">
                            ...
                            <span className="text-lg font-extrabold tracking-tight">Entrar no nosso Grupo VIP</span>
                        </div>
                        <p className="text-[10px] opacity-90 font-medium leading-tight max-w-[280px]">
