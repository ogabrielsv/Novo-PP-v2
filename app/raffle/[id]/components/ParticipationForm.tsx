            ...
            <div className="bg-black border border-stone-800 rounded-3xl p-8 text-center space-y-6 animate-in fade-in zoom-in duration-300 relative overflow-hidden ring-1 ring-white/10">
                ...
                <div className="space-y-3 relative z-10 pt-2">
                    <a
                        ...
                        className="w-full bg-[#25D366] hover:bg-[#22c55e] text-white font-extrabold py-5 rounded-2xl transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-xl shadow-green-900/30 flex items-center justify-center gap-3 relative overflow-hidden group"
                    >
                        ...
                        <span className="text-lg relative z-10">Entrar no Grupo de Novidades</span>
                    </a>
