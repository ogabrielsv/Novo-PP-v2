    ...
    try {
        ...
        const raffle = await prisma.raffle.create({
            data: {
                ...
                showProgressBar: showProgressBar !== undefined ? showProgressBar : false,
                progressBarValue: progressBarValue !== undefined ? Math.max(0, Math.min(100, parseInt(progressBarValue) || 0)) : 0,
            }
        });
